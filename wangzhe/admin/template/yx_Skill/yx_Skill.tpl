...
{block name=title}英雄技能管理-列表{/block}
								...
								<div class="clearfix">
									...
									<tbody>
										...
										<tr class="">
                                                                                        ...
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.id}</td>
											<td style="text-align:center;padding-top: 30px;">{$v.name}</td>
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.url}</td>
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.cd}</td>
											<td style="text-align:center;padding-top: 30px;">{$v.pm}</td>
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.porperty}</td>                                                                                    
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.num}</td>
                                                                                        <td style="text-align:center;padding-top: 30px;">{$v.hero_id}</td>
...
*}
                                                                                        ...
                                                                                        <td style="text-align:center;padding-top: 30px;">                                                                                       
                                                                                            <a href="index.php?class=yx_Skill&action=edit&id={$v.id}">修改</a>
                                                                                       
                                                                                             <a href="index.php?class=yx_Skill&action=Delete&id={$v.id}">删除</a>
