										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
                                                                                                            <input type="text" placeholder="请输入技能" class="m-wrap small"  name="name" value="{$info[0].name}"/>
													</div>
												</div>
                                                                                              <div class="control-group">
													...
													<div class="controls" >
                                                                                                            <img src="{$info[0].big_image}" width="100" id="upload_img"/>
													...
													<div class="controls">
                                                                                                            <input type="text" placeholder="请输入技能介绍" class="m-wrap small"  name="jieshao" value="{$info[0].decribe}"/>
													</div>
												</div>
                                                                                            <div class="control-group">
													<label class="control-label">适用英雄：</label>
													<div class="controls">
                                                                                                            <input type="text" placeholder="请输入英雄" class="m-wrap small"  name="shiyong" value="{$info[0].unlock_level}"/>
													</div>
												</div>
