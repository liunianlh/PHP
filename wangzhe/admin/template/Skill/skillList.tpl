...
{block name=title}技能管理-列表{/block}
									...
									<tbody>
										...
										<tr class="">
											...
											<td style="text-align:center;padding-top: 40px;">{$v.decribe}</td>
                                                                                        <td style="text-align:center;padding-top: 40px;">{$v.unlock_level}</td>
                                                                                        ...
                                                                                        <td style="text-align:center;padding-top: 40px;">                                                                                       
                                                                                            <a href="index.php?class=Skill&action=edit&id={$v.id}">修改</a>
                                                                                       
                                                                                             <a href="index.php?class=Skill&action=Delete&id={$v.id}">删除</a>
