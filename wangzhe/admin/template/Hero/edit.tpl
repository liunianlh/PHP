...
{block name=title}英雄管理-修改{/block}
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="请输入英雄名称" class="m-wrap small"  name="name" value="{$info[0].name}"/>
													</div>
												</div>
													...
													<div class="controls" >
                                                                                                            <img src="{$info[0].photo}" width="100" id="upload_img"/>
                                       
												            <input type="file" value="" name="myfile" class="m-wrap small" style="display:none;"/>
                                                                                                            <input type="hidden" value="{$info[0].photo}" id="upload_url" name="url"/>
													</div>
												</div>
                                                                                                 <div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="请输入生存能力" class="m-wrap small"  name="live" value="{$info[0].live}"/>
													</div>
												</div>
                                                                                                        <div class="control-group">
													<label class="control-label">攻击伤害：</label>
													<div class="controls">
														<input type="text" placeholder="请输入伤害能力" class="m-wrap small"  name="hurt" value="{$info[0].hurt}"/>
													</div>
												</div>
                                                                                                  <div class="control-group">
													<label class="control-label">技能效果：</label>
													<div class="controls">
														<input type="text" placeholder="上手难度" class="m-wrap small"  name="effect" value="{$info[0].effect}"/>
													</div>
												</div>       
                                                                                                 <div class="control-group">
													<label class="control-label">上手难度：</label>
													<div class="controls">
														<input type="text" placeholder="上手难度" class="m-wrap small"  name="difficulty" value="{$info[0].difficulty}" />
													</div>
												</div>
                                                                                                 <div class="control-group">
													...
													<div class="controls">
                                                                                                            <textarea name="story" class="m-wrap large" name="story" value="{$info[0].story}">{$info[0].story}</textarea>
													</div>
												</div
