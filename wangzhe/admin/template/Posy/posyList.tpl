								...
								<div class="clearfix">
									...
									<tbody>
										...
										<tr class="">
											...
											<td style="text-align:center;padding-top: 40px;">{$v.miaosu}</td>
                                                                                        ...
                                                                                        <td style="text-align:center;padding-top: 40px;">                                                                                       
                                                                                            <a href="index.php?class=Posy&action=edit&id={$v.id}">修改</a>
                                                                                       
                                                                                             <a href="index.php?class=Posy&action=Delete&id={$v.id}">删除</a>
