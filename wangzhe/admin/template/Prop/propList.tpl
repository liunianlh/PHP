									...
									<tbody>
										...
										<tr class="">
											...
											<td style="text-align:center;padding-top: 40px;">{$v.name}</td>
                                                                                         ...
                                                                                         <td style="text-align:center;padding-top: 40px;">{$v.type}</td>

											<td style="text-align:center;padding-top: 40px;">{$v.price}</td>
                                                                                        <td style="text-align:center;padding-top: 40px;">{$v.total}</td>
                                                                                             <td style="text-align:center;padding-top: 40px;">{$v.decribe}</td>
											<td style="text-align:center;padding-top: 40px;">{$v.attribute}</td>
                                                                                        ...
                                                                                        <td style="text-align:center;padding-top: 40px;">                                                                                       
                                                                                            <a href="index.php?class=Prop&action=edit&id={$v.id}">修改</a>
                                                                                       
                                                                                             <a href="index.php?class=Prop&action=Delete&id={$v.id}">删除</a>
