<?php
/* Smarty version 3.1.30, created on 2018-01-15 15:17:42
  from "E:\phpstudy\www\movie\Application\Home\View\Dingdan\Dingdan.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a5c5596b2bb82_50294881',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '944af2344be918e4cd6aeb75b8f3a738f38505b7' => 
    array (
      0 => 'E:\\phpstudy\\www\\movie\\Application\\Home\\View\\Dingdan\\Dingdan.html',
      1 => 1516000660,
      2 => 'file',
    ),
  ),
...
function content_5a5c5596b2bb82_50294881 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
>
 ...
 <?php echo $_smarty_tpl->tpl_vars['list']->value["people_row"];?>
排 <?php echo $_smarty_tpl->tpl_vars['list']->value["people_line"];?>
座</p>
			</div>
<!--			<div class="top_right">
		...
		<div class="fuqian">
			...
			<div class="fuqian_mingxi">
				...
				<div class="fuqian_mingxi_botttom">
					...
					<p>特惠票</p>
				<div>
					<span>促</span><?php echo $_smarty_tpl->tpl_vars['list']->value["money"]["money"];?>
-3元x1
				</div>
				</div>
			</div>
		...
		<div class="funqian_bottom">
			<div class="fuqian_top">
				...
				<div class="fuqian_top_right"  id="fuqian">
					应返&nbsp;<span><span><?php echo $_smarty_tpl->tpl_vars['list']->value["money"]["money"]-3;?>
</span>元</span>
					<img src="Public/img/sanjiaoxia.png"/>
				</div>
			</div>
...
>
			...
			$(".fuqian_top_left").click(function(){
				$(".fuqian").show();
				$(".fuqian_xuzhi").show();
				$(".fuqian_top_left img").attr("src","Public/img/sanjiaotop.png");
			});
			$("#quxiao1").click(function(){
				$(".fuqian").hide();
				$(".fuqian_xuzhi").hide();
				$(".fuqian_top_left img").attr("src","Public/img/sanjiaoxia.png");
			});
			//<!--结算明细-->
			$("#fuqian").click(function(){
				$(".fuqian").show();
				$(".fuqian_mingxi").show();
				$("#fuqian img").attr("src","Public/img/sanjiaotop.png");
			});
			$("#quxiao2").click(function(){
				$(".fuqian").hide();
				$(".fuqian_mingxi").hide();
				$("#fuqian img").attr("src","Public/img/sanjiaoxia.png");
			});
